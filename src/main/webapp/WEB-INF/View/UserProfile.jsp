...
<body>
	...
	<h1>eWallet</h1>
		...
		<h2><a href="updateAccounts?profileId=${profile.profileId}">View Current eWallet Balance</a></h2>
		<h2><a href="updatePassword?profileId=${profile.profileId}">View Transactions</a></h2>	
</body>
</html>
